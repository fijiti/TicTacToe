// This variable keeps track of who's turn it is.center-container
let activePlayer = 'X';
// This array stores moves.  We use this to determine win condition 
let selectedSquares = [];
...
function placeXOrO(squareNumber) {
    ...
    //see if it cointains the square number clicked on.  
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        if (activePlayer === 'O') {
            //This funciton disables clicking for computer choice.
            disableClick();
...
function checkWinConditions() {
    ...
    //and 9 squares are selected, the code executes.  
        ...
        //This function plays the tie gome sound.  
        audio('./media/tie.mp3');
        // This function sets a .3 second timeer before the resetGame is called.  
    ...
    function arrayIncludes(squareA, squareB, squareC) {
        ...
        //returned and our else if condition executes the drawWinLine furnction.  
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    //This function interacts with the caanvas.
    function animateLineDrawing() {
        ...
        if(x1 <= x2 && y1 <= y2) {
            ...
            if (x < x2) {x += 10;}
            //This condition adds 10to the previous end y point. 
            if (y < y2) { y += 10; }
